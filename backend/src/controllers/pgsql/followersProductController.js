...
// Fonction pour récupérer les produits achetés par les followers d'un utilisateur à plusieurs niveaux pour un produit spécifique
const getFollowersProductsForSpecificProductSQL = (userId, depth, productId, res) => {
    const query = `
        ...
        WHERE p.id = $3  -- Produit spécifique
...
module.exports = {
    getFollowersProductsForSpecificProductSQL,
};
